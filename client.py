...
class TLS_Record():
    ...
    def __init__(self):
        ...
        self.record[16] = self.get_random_sni()
    ...
    def get_ec_algorithms(self) -> bytes:
        return b'\x00\x0d\x00\x16\x00\x14\x06\x01\x06\x03\x05\x01\x05\x03\x04\x01\x04\x03\x03\x01\x03\x03\x02\x01\x02\x03'
...
class Sender():
    def __init__(self, proxy:tuple, tls_record:TLS_Record):
